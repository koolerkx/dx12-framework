...
void MaterialRenderer::RecordSingle(RenderCommandList& cmd, const SingleDrawCommand& draw_cmd, const XMMATRIX& view_proj) {
...
void MaterialRenderer::RecordInstance(RenderCommandList& cmd, const InstanceDrawCommand& draw_cmd) {
  // Set material instance data (texture indices, etc)
  cmd.SetMaterialData(draw_cmd.material_instance);
