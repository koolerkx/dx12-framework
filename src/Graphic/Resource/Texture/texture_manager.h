...
class TextureManager {
 public:
  ...
  std::shared_ptr<Texture> LoadTextureFromMemory(const std::string& cache_key, const uint8_t* data, size_t size, bool force_srgb);
 ...
 private:
  ...
  std::shared_ptr<Texture> FinalizeTexture(
  ...
  bool LoadFromRawPixelsAndGenerateMipmaps(
