...
#ifndef MATERIAL_FLAG_ALPHA_TEST
...
#define BINDLESS_MATERIAL_SENTINEL 0xFFFFFFFF
...
bool UseBindlessMaterial(uint materialDescriptorIndex) {
  return materialDescriptorIndex != BINDLESS_MATERIAL_SENTINEL;
}
